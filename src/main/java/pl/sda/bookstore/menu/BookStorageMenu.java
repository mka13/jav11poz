...
public class BookStorageMenu {
    ...
    private void initBook() {
        List<Book> books = BookManager.createBooks();
    ...
    public void showMenu() {
        while(true) {
            ...
            System.out.println("4. Wyświetl książki posortowane alfabetycznie po tytule");
            System.out.println("5. Wszystkie książki posortowane po raitingu");
